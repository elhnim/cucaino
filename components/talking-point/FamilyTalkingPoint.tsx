...
import { generateTalkingPoint } from "@/lib/actions/talking-point";
...
export default function FamilyTalkingPoint({ kidId }: FamilyTalkingPointProps) {
  ...
  const handlePlay = useCallback(async () => {
    ...
    const result = await generateTalkingPoint(category, recentAnswers(`talking-point:${category}`));
    if (!result.ok) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-cyan-100">
      <div className="max-w-lg mx-auto p-4 pt-5">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-black text-gray-900 flex-1">💬 Family Talking Point</h1>
        </div>
