...
export const TRADING_ASSETS: TradingAsset[] = [
  { symbol: "MOON",  name: "Moonbucks",           emoji: "☕", industry: "Coffee & drinks", basePriceNuggets: 50, paysDividend: true,  description: "Moonbucks is the coffee shop on every corner where parents grab their morning brew and kids get hot chocolate." },
  ...
  { symbol: "DYSN",  name: "Dysnei",               emoji: "🏰", industry: "Theme parks & films", basePriceNuggets: 90, paysDividend: true, description: "Dysnei runs the most magical theme parks on Earth and makes the animated movies everyone grows up with." },
