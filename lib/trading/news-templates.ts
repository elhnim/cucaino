...
export const NEWS_TEMPLATES: Record<string, NewsTemplate[]> = {
  ...
  product_hit: [
    ...
    { text: "Kids rate the new release {X} out of 10 in early reviews", body: "Early reviewers gave the new product {X} out of 10, praising how easy and fun it was. The company said it was thrilled with the warm welcome.", impact: 'positive', minPct: 5, maxPct: 12 },
    ...
    { text: "Updated design wins {X} new design awards", body: "A fresh redesign picked up {X} industry awards this season. Judges praised the bold new look and clever details.", impact: 'positive', minPct: 5, maxPct: 12 },
  ...
  product_flop: [
    ...
    { text: "Critics give the latest release just {X} out of 10", body: "Reviewers handed the new product a disappointing {X} out of 10. Many said it failed to live up to the hype.", impact: 'negative', minPct: 5, maxPct: 10 },
    { text: "Product launch delayed by {X} months, fans frustrated", body: "The eagerly awaited release slipped back {X} months, leaving fans annoyed. The company blamed problems getting the product just right.", impact: 'negative', minPct: 5, maxPct: 12 },
    ...
    { text: "New CEO overhauls strategy, scraps {X} planned products", body: "The new boss cancelled {X} products that were in the works as part of a shake-up. Some fans were sad to see favourites dropped before launch.", impact: 'negative', minPct: 5, maxPct: 10 },
  ...
  neutral_news: [
    { text: "Company announces {X} new jobs at headquarters", body: "The company said it would hire {X} new staff at its head office over the coming year. Local leaders welcomed the extra jobs for the area.", impact: 'neutral', minPct: 0, maxPct: 3 },
    { text: "CEO spotted at industry conference talking about the next {X} years", body: "The boss gave a talk at a big industry event about plans for the next {X} years. The speech was light on detail but heavy on big ideas.", impact: 'neutral', minPct: 0, maxPct: 2 },
    { text: "Headquarters moves to new {X}-floor building downtown", body: "The company is moving into a new {X}-floor office in the city centre. Staff said they were looking forward to the modern space.", impact: 'neutral', minPct: 0, maxPct: 2 },
    { text: "Company celebrates {X} years in business this week", body: "The company marked {X} years in business with a small celebration for staff. Founders thanked loyal customers for the journey so far.", impact: 'neutral', minPct: 0, maxPct: 2 },
    { text: "Annual report shows steady results with {X}% year-on-year change", body: "The yearly report showed a modest {X}% change from last year, broadly in line with expectations. Bosses described it as a steady, no-surprises year.", impact: 'neutral', minPct: 0, maxPct: 3 },
    { text: "Analysts keep their {X} rating unchanged after quarterly review", body: "Market watchers left their {X} rating untouched following the latest review. They said there was little new to change their minds.", impact: 'neutral', minPct: 0, maxPct: 2 },
    { text: "Company donates {X} thousand to local schools this month", body: "The company gave {X} thousand to schools in its home town this month. Teachers said the money would go toward new books and equipment.", impact: 'neutral', minPct: 0, maxPct: 2 },
    { text: "Research team expanded with {X} new scientists joining", body: "The company welcomed {X} new scientists to its research team. Bosses said the hires would help with long-term projects.", impact: 'neutral', minPct: 0, maxPct: 3 },
    { text: "Board reshuffle brings in {X} new directors", body: "The company added {X} new directors in a routine board reshuffle. Bosses said the fresh faces brought useful experience.", impact: 'neutral', minPct: 0, maxPct: 2 },
    { text: "Company refreshes its logo after {X} years", body: "A new logo was unveiled after {X} years with the old design. Reaction was mixed, with some fans nostalgic for the original.", impact: 'neutral', minPct: 0, maxPct: 2 },
    { text: "Factory tour opens to the public for {X} weekends", body: "The company opened its factory to visitors for {X} weekends running. Families enjoyed a behind-the-scenes peek at how things are made.", impact: 'neutral', minPct: 0, maxPct: 2 },
    { text: "Company publishes its {X}-page sustainability report", body: "A detailed {X}-page report set out the company's environmental plans. Campaigners said they would be watching to see if the promises were kept.", impact: 'neutral', minPct: 0, maxPct: 3 },
    { text: "Annual general meeting draws {X} shareholders", body: "About {X} shareholders turned up to the company's yearly meeting. The agenda was routine, with no big announcements expected.", impact: 'neutral', minPct: 0, maxPct: 2 },
    { text: "Company sponsors local youth team for {X} seasons", body: "The company signed up to back a local youth team for the next {X} seasons. Coaches said the support would help buy kit and equipment.", impact: 'neutral', minPct: 0, maxPct: 2 },
  ],
  mixed_news: [
    ...
    { text: "CEO unexpectedly steps down after {X} years — replacement unknown", body: "The long-serving boss stepped down after {X} years, surprising the market. No replacement has been named, leaving the future uncertain.", impact: 'mixed', minPct: 7, maxPct: 15 },
    { text: "Rumours of a secret product launch in {X} weeks — details unclear", body: "Whispers suggest a secret product could launch in about {X} weeks. The company would neither confirm nor deny the rumours.", impact: 'mixed', minPct: 5, maxPct: 12 },
    ...
    { text: "Huge new factory planned — exciting but {X} million to build", body: "Plans for a massive new factory were unveiled, set to cost {X} million. Supporters called it a vote of confidence; doubters worried about the price tag.", impact: 'mixed', minPct: 6, maxPct: 13 },
    { text: "Surprise price change leaves {X}% of shoppers undecided", body: "An unexpected price change left about {X}% of shoppers unsure whether to buy. The company said it was confident customers would come around.", impact: 'mixed', minPct: 5, maxPct: 12 },
    ...
    { text: "Company bets {X} million on untested new technology", body: "The company is pouring {X} million into a brand new technology no rival has tried. It could leap ahead of the pack — or be a costly dead end.", impact: 'mixed', minPct: 7, maxPct: 14 },
